    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-[#050505] to-emerald-950 relative overflow-hidden">
      ...
      <div className="p-6">
        <div className="grid gap-6 lg:grid-cols-4">
          ...
          {/* Settings Content */}
          <Card className="lg:col-span-3 glass-card border-white/[0.15] bg-white/[0.08] backdrop-blur-3xl shadow-[0_0_30px_rgba(255,255,255,0.05)] p-8">
            {activeTab === "profile" && (
            ...
            {activeTab === "api" && (
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <Card className="glass-card border-white/[0.15] bg-white/[0.08] backdrop-blur-3xl shadow-[0_0_30px_rgba(255,255,255,0.05)] p-4">
